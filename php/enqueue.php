...
function loadAssets()
{
    ...
    wp_register_script_module('@tsjippy/password_strength_script', TSJIPPY\pathToUrl(PLUGINPATH . 'js/password_strength.min.js'), array('@tsjippy/form_submit_functions'), PLUGINVERSION);
