...
class CreationCeremony extends WebAuthCeremony
{
    ...
    protected function storeCredential($data, $identifier): void
    {
         ...
         */
        add_user_meta($this->user->ID, "_tsjippy_2fa_webauthn_cred_meta", base64_encode(serialize($meta)));

        add_user_meta($this->user->ID, "_tsjippy_2fa_webauthn_cred", base64_encode(serialize($data)));
